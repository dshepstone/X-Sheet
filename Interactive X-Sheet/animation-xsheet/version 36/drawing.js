...
(function (app) {
    ...
    class DrawingLayerSystem {
        ...
        updateLayoutSize() {
            ...
            const newWidth = this.xsheetTable.offsetWidth;
            const newHeight = this.xsheetTable.offsetHeight;

            // Update container position and size relative to printableArea (its parent)
            // using the table's offset properties.
            ...
            // Update each layer canvas size
            this.layers.forEach(layer => {
                layer.canvas.width = newWidth;
                layer.canvas.height = newHeight;
            });

            // Redraw all objects onto the newly sized canvases
            this.redrawAll();
        }
