...
(function (app) {
    ...
    function prepareForExport() {
        ...
        // Render drawings directly into cells
        if (app.Drawing && app.Drawing.state.layerSystem) {
            // Make original drawing layers invisible during export
            app.Drawing.state.layerSystem.layers.forEach(layer => {
                layer.canvas.style.display = 'none';
            });

            // Render drawings directly into cells
            app.Drawing.state.layerSystem.renderDrawingsIntoCells();
        }
    }
    ...
    function cleanupAfterPrint() {
        ...
        // Restore drawings from cells
        if (app.Drawing && app.Drawing.state.layerSystem) {
            app.Drawing.state.layerSystem.restoreDrawingsFromCells();
        }
    }
